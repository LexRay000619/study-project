...
const rules = {
    username: [
        ...
        {min: 2, max: 8, message: '用户名长度必须在2-8个字符之间', trigger: ['blue', 'change']}
    ],
    password: [
        {required: true, message: '请输入密码', trigger: 'blur'},
        {min: 6, max: 16, message: '密码长度必须在6-16个字符之间', trigger: ['blue', 'change']}
    ],
    password_repeat: [
            ...
            <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef">
                ...
                <el-form-item prop="code">
                    <el-row :gutter="10" style="width: 100%">
                        ...
                        <el-col :span="7">
                            <el-button type="success" style="text-align: right" @click="validateEmail"
